...
class JClassTestCase(common.JPypeTestCase):
    ...
    def testJavaPrimitives(self):
        self.assertIsInstance(
            self.fixture.callObject(JByte(1)), JClass('java.lang.Byte'))
        self.assertIsInstance(
            self.fixture.callObject(JShort(1)), JClass('java.lang.Short'))
        self.assertIsInstance(
            self.fixture.callObject(JInt(1)), JClass('java.lang.Integer'))
        self.assertIsInstance(
            self.fixture.callObject(JLong(1)), JClass('java.lang.Long'))
        self.assertIsInstance(
            self.fixture.callObject(JFloat(1)), JClass('java.lang.Float'))
        self.assertIsInstance(self.fixture.callObject(
            JDouble(1)), JClass('java.lang.Double'))

    def testPythonPrimitives(self):
        self.assertIsInstance(self.fixture.callObject(1), JClass('java.lang.Long'))
        self.assertIsInstance(self.fixture.callObject(1.0), JClass('java.lang.Double'))

    @common.requireNumpy
    def testNumpyPrimitives(self):
        self.assertIsInstance(
            self.fixture.callObject(np.int8(1)), JClass('java.lang.Byte'))
        self.assertIsInstance(self.fixture.callObject(
