...
class ProxyTestCase(common.JPypeTestCase):
    ...
    def setUp(self):
        ...
        self._triggers = JClass('jpype.proxy.ProxyTriggers')
    ...
    def testProxyDecl(self):
        ...
        itf1 = JClass('jpype.proxy.TestInterface1')
        itf2 = JClass('jpype.proxy.TestInterface2')
    ...
    def testProxyWithDictInherited(self):
        ...
        itf3 = JClass('jpype.proxy.TestInterface3')
    ...
    def testProxyWithThread(self):
        itf = JClass('jpype.proxy.TestThreadCallback')
    ...
    def testValid(self):
        ...
        JClass('java.util.Arrays').sort(arr, ValidComparator())
    ...
    def testRaisePython(self):
        ...
        with self.assertRaises(TypeError):
            Arrays.sort(arr, RaiseException(TypeError))
        with self.assertRaises(ValueError):
            Arrays.sort(arr, RaiseException(ValueError))
        with self.assertRaises(SyntaxError):
            Arrays.sort(arr, RaiseException(SyntaxError))
        with self.assertRaises(RuntimeException):
            Arrays.sort(
                arr, RaiseException(RuntimeException))
    ...
    def testMethods(self):
        ...
        self.assertIsInstance(s.getClass(), JClass('java.lang.Class'))
        self.assertIsInstance(s.toString(), JClass('java.lang.String'))
    ...
    def testWeak(self):
        hc = JClass('java.lang.System').identityHashCode
        @JImplements("java.io.Serializable")
        class MyObj(object):
            pass
