...
class ObjectWrapperTestCase(common.JPypeTestCase):
    def testCallOverloads(self):
        ...
        o = JClass('java.lang.Integer')(1)
        self.assertEqual(h.Method1(JObject(o, JClass('java.lang.Number'))), 1)
        self.assertEqual(h.Method1(o), 2)
        self.assertEqual(h.Method1(JObject(JClass('java.lang.Integer')(1),
                                           JClass('java.lang.Object'))), 3)
    ...
    def testWrapJavaObjectCastFail(self):
        o = JClass('java.lang.Object')()
        c = JClass('java.lang.Math')
