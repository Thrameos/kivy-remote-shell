...
class OverloadTestCase(common.JPypeTestCase):
    ...
    def testPrimitive(self):
        ...
        self.assertEqual('Byte', test1.testPrimitive(JClass('java.lang.Byte')(5)))
        self.assertEqual('short', test1.testPrimitive(JShort(5)))
        self.assertEqual('Short', test1.testPrimitive(JClass('java.lang.Short')(5)))
        self.assertEqual('int', test1.testPrimitive(JInt(5)))
        self.assertEqual('Integer', test1.testPrimitive(JClass('java.lang.Integer')(5)))
        self.assertEqual('long', test1.testPrimitive(JLong(5)))
        self.assertEqual('Long', test1.testPrimitive(JClass('java.lang.Long')(5)))
        self.assertEqual('float', test1.testPrimitive(JFloat(5)))
        self.assertEqual('Float', test1.testPrimitive(JClass('java.lang.Float')(5.0)))
        self.assertEqual('double', test1.testPrimitive(JDouble(5)))
        self.assertEqual('Double', test1.testPrimitive(JClass('java.lang.Double')(5.0)))
        self.assertEqual('boolean', test1.testPrimitive(JBoolean(5)))
        self.assertEqual('Boolean', test1.testPrimitive(JClass('java.lang.Boolean')(5)))
        self.assertEqual('char', test1.testPrimitive(JChar('5')))
        self.assertEqual('Character', test1.testPrimitive(
            JClass('java.lang.Character')('5')))

    def testInstanceVsClassMethod(self):
        # this behaviour is different than the one in java, so maybe we should change it?
        test1 = JClass('jpype.overloads.Test1')()
        self.assertEqual(
            'static B', JClass('jpype.overloads.Test1').testInstanceVsClass(self._c))
        self.assertEqual('instance A', test1.testInstanceVsClass(self._c))
        # here what would the above resolve to in java
        self.assertEqual(
            'static B', JClass('jpype.overloads.Test1').testJavaInstanceVsClass())
    ...
    def testStringArray(self):
        ...
        self.assertEqual('String[]', test1.testStringArray(
            JArray(JClass('java.lang.String'), 1)(['a', 'b'])))
