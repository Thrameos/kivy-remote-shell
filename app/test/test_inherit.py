...
class InheritTestCase(common.JPypeTestCase):
    ...
    def testString(self):
        ...
        self.assertIsSubclass(JClass('java.lang.String'), JObject)
        self.assertIsSubclass(JString, JString)
        self.assertIsSubclass(JClass('java.lang.String'), JString)
        self.assertIsInstance(JString("f"), JObject)
        self.assertIsInstance(JClass('java.lang.String')("f"), JObject)
        self.assertIsInstance(JString("f"), JString)
        self.assertIsInstance(JClass('java.lang.String')("f"), JString)
        self.assertNotIsInstance(JString, JInterface)
        self.assertNotIsInstance(JClass('java.lang.String'), JInterface)
        self.assertIsSubclass(JString, JClass('java.lang.String'))

    def testObject(self):
        self.assertIsInstance(JObject, JClass)
        self.assertIsInstance(JClass('java.lang.Object'), JClass)
        self.assertNotIsSubclass(JObject, JInterface)
        self.assertNotIsSubclass(JClass('java.lang.Object'), JInterface)
        self.assertIsSubclass(JObject, JObject)
        self.assertIsSubclass(JObject, JClass('java.lang.Object'))
        self.assertNotIsSubclass(JObject, JException)
        self.assertNotIsInstance(JObject(), JInterface)
        self.assertNotIsInstance(JClass('java.lang.Object')(), JInterface)
        self.assertIsInstance(JObject(), JObject)
        self.assertIsInstance(JObject(), JClass('java.lang.Object'))
    ...
    def testException(self):
        ...
        self.assertIsInstance(JClass('java.lang.Throwable'), JClass)
        self.assertNotIsSubclass(JException, JInterface)
        self.assertNotIsSubclass(JClass('java.lang.Throwable'), JInterface)
        self.assertIsSubclass(JException, Exception)
        self.assertIsSubclass(JException, JException)
        self.assertNotIsInstance(JClass('java.lang.Throwable')("f"), JInterface)
        th = JClass('java.lang.Throwable')("foo")
        self.assertIsInstance(th, JObject)
        self.assertIsInstance(th, JClass('java.lang.Object'))
        self.assertIsInstance(th, JClass('java.lang.Throwable'))
    ...
    def testInterface(self):
        ...
        self.assertIsInstance(JClass('java.io.Serializable'), JInterface)
        self.assertIsSubclass(JClass('java.io.Serializable'), JInterface)
