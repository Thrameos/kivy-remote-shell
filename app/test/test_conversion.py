...
class ConversionTestCase(common.JPypeTestCase):
    ...
    def testUnbox(self):
        ...
        java = jpype.java
        jf.static_bool_field = JClass('java.lang.Boolean')(True)
        self.assertEqual(jf.static_bool_field, True)
        jf.static_char_field = JClass('java.lang.Character')("a")
        self.assertEqual(jf.static_char_field, "a")
        jf.static_byte_field = JClass('java.lang.Byte')(123)
        self.assertEqual(jf.static_byte_field, 123)
        jf.static_short_field = JClass('java.lang.Short')(123)
        self.assertEqual(jf.static_short_field, 123)
        jf.static_int_field = JClass('java.lang.Integer')(123)
        self.assertEqual(jf.static_int_field, 123)
        jf.static_long_field = JClass('java.lang.Long')(123)
        self.assertEqual(jf.static_long_field, 123)
        jf.static_float_field = JClass('java.lang.Float')(123)
        self.assertEqual(jf.static_float_field, 123)
        jf.static_double_field = JClass('java.lang.Double')(123)
        self.assertEqual(jf.static_double_field, 123)

    def testUnboxFail(self):
        java = jpype.java
        with self.assertRaises(TypeError):
            JBoolean._convertToJava(JClass('java.lang.Double')(1))
        with self.assertRaises(TypeError):
            JChar._convertToJava(JClass('java.lang.Double')(1))
        with self.assertRaises(TypeError):
            JByte._convertToJava(JClass('java.lang.Boolean')(1))
        with self.assertRaises(TypeError):
            JShort._convertToJava(JClass('java.lang.Boolean')(1))
        with self.assertRaises(TypeError):
            JInt._convertToJava(JClass('java.lang.Boolean')(1))
        with self.assertRaises(TypeError):
            JLong._convertToJava(JClass('java.lang.Boolean')(1))
        with self.assertRaises(TypeError):
            JFloat._convertToJava(JClass('java.lang.Boolean')(1))
        with self.assertRaises(TypeError):
            JDouble._convertToJava(JClass('java.lang.Boolean')(1))

    def testBox(self):
        java = jpype.java
        self.assertEqual(JClass('java.lang.Boolean')(JBoolean(True)), True)
        # FIXME this one fails
        #self.assertEqual(java.lang.Character')(JChar("A")), "A")
        self.assertEqual(JClass('java.lang.Byte')(JByte(123)), 123)
        self.assertEqual(JClass('java.lang.Short')(JShort(123)), 123)
        self.assertEqual(JClass('java.lang.Integer')(JInt(123)), 123)
        self.assertEqual(JClass('java.lang.Long')(JLong(123)), 123)
        self.assertEqual(JClass('java.lang.Float')(JFloat(123)), 123)
        self.assertEqual(JClass('java.lang.Double')(JDouble(123)), 123)
